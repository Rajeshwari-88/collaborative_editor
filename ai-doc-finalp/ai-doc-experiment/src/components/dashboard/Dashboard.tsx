        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`p-2 rounded-lg ${viewMode === 'grid' ? 'bg-teal-100 text-teal-600' : 'text-gray-600 hover:bg-gray-100'}`}
            >
              <Grid className="h-4 w-4" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-2 rounded-lg ${viewMode === 'list' ? 'bg-teal-100 text-teal-600' : 'text-gray-600 hover:bg-gray-100'}`}
            >
                ...
                {viewMode === 'grid' ? (
                  <>
                    <div className="flex items-start justify-between mb-4">
                      <div className="bg-teal-50 rounded-lg p-3 group-hover:bg-teal-100 transition-colors">
                  ...
                  <>
                    <div className="bg-teal-50 rounded-lg p-3 mr-4 group-hover:bg-teal-100 transition-colors">
                      <FileText className="h-6 w-6 text-teal-600" />
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 mb-6"
